...
fellows %>% 
  ...
  mac_dotplot(x = "Percent of All Awards", 
              title = "MacArthur Fellowships by Affiliation, 1981-2019", 
              subtitle = "Institutions with three or more affiliated fellows. Excludes 'No Affiliation.'") 
```
...
fellows %>% 
  ...
  mac_dotplot(x = "Percent of All Awards", 
       title = "MacArthur Fellowships by Title, 1981-2019", 
       subtitle = "Titles mentioned three or more times. Excludes 'No Title.'")
```

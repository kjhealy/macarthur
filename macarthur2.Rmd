...
p + geom_jitter(alpha = 0.5, shape = 1, position = position_jitter()) +  
  ...
  labs(x = "Year of Award", y = "Age at Time of Award", 
       title = "Age Distribution of MacArthur Award Winners over time", 
       caption = "@kjhealy / socviz.co Data: John D. and Catherine T. MacArthur Foundation.") + 
